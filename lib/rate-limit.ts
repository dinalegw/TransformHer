...
const RATE_LIMITS: Record<string, { limit: number; windowMs: number }> = {
  ...
  '/api/admin/users/delete': { limit: 5, windowMs: 5 * 60_000 },
  '/api/admin/deleted-users/review': { limit: 10, windowMs: 60_000 },
  '/api/admin/deleted-users/legal-hold': { limit: 5, windowMs: 5 * 60_000 },
  '/api/admin/books/mutate': { limit: 30, windowMs: 60_000 },
  '/api/admin/books/review': { limit: 20, windowMs: 60_000 },
  '/api/admin/books/upload': { limit: 5, windowMs: 60_000 },
