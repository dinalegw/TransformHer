...
export function LoginForm({ initialRedirect = '/books', initialError = '' }: LoginFormProps) {
  const router = useRouter()
  const redirectTo = initialRedirect.startsWith('/') && !initialRedirect.startsWith('//')
    ? initialRedirect
    : '/books'
    ...
    <div className="flex min-h-svh flex-col">
      ...
      <main className="flex flex-1 items-center justify-center px-4 py-16">
        <div className="w-full max-w-sm">
          ...
          <form action="/api/auth/login" method="post" onSubmit={handleSubmit} className="mt-8 space-y-5">
