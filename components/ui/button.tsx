...
function Button({
  ...
  // `asChild` is used for Next.js links throughout the app. Keep the child as
  // an actual anchor instead of wrapping it in Base UI button semantics. This
  // preserves native navigation before/after hydration and avoids click
  // handling conflicts on auth/navigation links.
